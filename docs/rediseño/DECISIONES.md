...
| 5 | Métricas de comunidad | **Constante editable en el frontend** (`src/config/communityStats.js` o similar), con footnote de fecha de última revisión manual. Sin endpoint nuevo. |
